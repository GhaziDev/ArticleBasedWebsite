...
class SignupView(viewsets.ModelViewSet):
    ...
    def create(self,request):
        ...
        if data.is_valid():
            ...
            send_mail(subject='Email Confirmation',message=f'Click on this link to verify your email : http://127.0.0.1:8000/verify/{token}/{user.id}',from_email=None, recipient_list=[email])
